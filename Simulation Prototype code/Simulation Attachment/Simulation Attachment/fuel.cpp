...
unsigned int __stdcall engineManager(void* data)
{
	...
	float pressureToSet = 0, engineFactor, towFactor;
	float engineSpeed = 0;
	...
	for (;;)
	{
		if (theEngine().engineStatus() == true)
		{
			...
			else
			{
				...
				//cout << endl << "Engine speed : " << engineSpeed << endl;
				//cout << endl << "original engine factor " << engineFactor << endl;
				...
				//cout << endl << "Final engine factor " << engineFactor << endl;
				pressureToSet = pressureToSet + engineFactor;
				//cout << endl << "Final pressure " << pressureToSet << endl;
